...
\noindent soit environ 500 observations de clocking. Cette constante devient l'intrant standard du calcul de coût~: ce qui varie d'un deal à l'autre n'est pas d'abord la vitesse de traitement d'un événement, mais le nombre d'événements que le deal génère et la charge d'aftercare associée.
