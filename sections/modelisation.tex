...
\begin{equation}
C_{\text{deal}} = \sum_{i=1}^{N} T_{s,i} \times w_{s}
= \underbrace{\sum_{i=1}^{N} \bar{t} \times w_{s}}_{\text{Event Processing}}
...
\begin{equation}
\hat{C}_{\text{deal}} = \Big[ \big(\hat{N}(x) \times 20\text{ min}\big) + \hat{T}_{\text{AC}}(x) \Big] \times 60\text{ €/h}
